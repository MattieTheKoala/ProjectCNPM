...
<body>
    ...
    <div class="container">
    	...
    	<div>
    		<div class="row">
    			<div class="col-3">
    				<img src="images/pokemon.jpg" width="100%">

    			</div>
    			<div class="col-4">
    				<h3>POKÉMON: THÁM TỬ PIKACHU</h3>
    				<p><b>Đạo diễn: </b>  Rob Letterman </p>
                    <p><b>Diễn viên: </b>   Ryan Reynolds, Suki Waterhouse, Justice Smith,...</p>
    				<p><b>Thể loại: </b>Hành Động, Khoa Học Viễn Tưởng</p>
    				<p><b>Khởi chiếu: </b> 10/05/2019 </p>
    				<p><b>Thời lượng:</b> </p>
