...
<body>
    ...
    <div class="container">
    	...
    	<div>
    		<div class="row">
    			<div class="col-3">
    				<img src="images/doraemon.jpg" width="100%">

    			</div>
    			<div class="col-4">
    				<h3>DORAEMON: NOBITA VÀ MẶT TRĂNG PHIÊU LƯU KÝ</h3>
    				<p><b>Đạo diễn: </b> Yakuwa Shinnosuke </p>
                    <p><b>Diễn viên: </b>   Wasabi Mizuta, Sang Hyun Uhm, Jung-jae Lee</p>
    				<p><b>Thể loại: </b>Gia đình, Hoạt Hình</p>
    				<p><b>Khởi chiếu: </b> 24/05/2019 </p>
    				<p><b>Thời lượng:</b> </p>
    				<p><b>Ngôn ngữ</b> Tiếng Nhật với phụ đề tiếng Việt</p>
    			</div>
