...
<body>
    ...
    <div class="container">
    	...
    	<div>
    		<div class="row">
    			<div class="col-3">
    				<img src="images/xmen.jpg" width="100%">

    			</div>
    			<div class="col-4">
    				<h3>X-MEN: PHƯỢNG HOÀNG BÓNG TỐI</h3>
    				<p><b>Đạo diễn: </b>  Simon Kinberg </p>
                    <p><b>Diễn viên: </b>    James McAvoy, Michael Fassbender, Jennifer Lawrence, Nicholas Hoult, Sophie Turner, Tye Sheridan, Alexandra Shipp, Kodi Smit-McPhee, Evan Peters, and Jessica Chastain</p>
    				<p><b>Thể loại: </b>Hành Động</p>
    				<p><b>Khởi chiếu: </b>  07/06/2019 </p>
    				<p><b>Thời lượng:</b> </p>
