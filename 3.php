...
<body>
    ...
    <div class="container">
    	...
    	<div>
    		<div class="row">
    			<div class="col-3">
    				<img src="images/avenger.jpg" width="100%">

    			</div>
    			<div class="col-4">
    				<h3>Avengers: Endgame</h3>
    				<p><b>Đạo diễn: </b>  Anthony Russo, Joe Russo</p>
    				<p><b>Diễn viên: </b> Robert Downey Jr., Chris Hemsworth, Mark Ruffalo, Chris Evans, Benedict Cumberbatch,...</p>
    				<p><b>Thể loại: </b>Hành Động, Khoa Học Viễn Tưởng</p>
    				<p><b>Khởi chiếu: </b>26/04/2019</p>
    				<p><b>Thời lượng</b> 182 Phút</p>
    				<p><b>Ngôn ngữ</b> Tiếng Anh với phụ đề tiếng Việt</p>
    				<p><b>Rated: C13 - PHIM CẤM KHÁN GIẢ DƯỚI 13 TUỔI</b></p>
    			</div>
