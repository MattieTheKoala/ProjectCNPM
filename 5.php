...
<body>
    ...
    <div class="container">
    	...
    	<div>
    		<div class="row">
    			<div class="col-3">
    				<img src="images/corgi.jpg" width="100%">

    			</div>
    			<div class="col-4">
    				<h3>CORGI: NHỮNG CHÚ CHÓ HOÀNG GIA</h3>
    				<p><b>Đạo diễn: </b>Ben Stassen</p>
                    <p><b>Diễn viên: </b> Jack Whitehall, Ray Winstone, Sheridan Smith, Julie Walters</p>
    				<p><b>Thể loại: </b>  Hoạt Hình, Phiêu Lưu, Tình cảm</p>
    				<p><b>Khởi chiếu: </b> 26/04/2019 </p>
    				<p><b>Thời lượng:</b>  85 phút</p>
    				<p><b>Ngôn ngữ</b> Tiếng Anh với phụ đề tiếng Việt</p>
                    <p><b>Rated: P - PHIM DÀNH CHO MỌI ĐỐI TƯỢNG</b></p>
    			</div>
