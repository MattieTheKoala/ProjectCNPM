...
<body>
    ...
    <div class="container">
    	...
    	<div>
    		<div class="row">
    			<div class="col-3">
    				<img src="images/chuyenViengThamTuThan.jpg" width="100%">

    			</div>
    			<div class="col-4">
    				<h3>CHUYẾN VIẾNG THĂM TỬ THẦN</h3>
    				<p><b>Đạo diễn: </b>Evgeniy Abyzov</p>
                    <p><b>Diễn viên: </b>  Yuri Chursin, Angelina Strechina, Mikhail Meshcheryakov,...</p>
    				<p><b>Thể loại: </b>  Hồi hộp, Kinh Dị</p>
    				<p><b>Khởi chiếu: </b> 03/05/2019 </p>
    				<p><b>Thời lượng:</b>   88 Phút</p>
    				<p><b>Ngôn ngữ</b> Tiếng Anh với phụ đề tiếng Việt</p>
                    <p><b>Rated: C18 - PHIM CẤM KHÁN GIẢ DƯỚI 18 TUỔI</b></p>
    			</div>
