...
<head>
	<meta charset="utf-8">
	<title>MinhBảo Cinema-Trang chủ</title>
...
<body>
    ...
    <br>
    <div class="container">
        <div><h2 align="center">NỘI DUNG PHIM</h2></div>
        <hr />
    	<div>
    		<div class="row">
    			<div class="col-3">
    				<img src="images/boVucTuThan.jpg" width="100%">

    			</div>
    			<div class="col-4">
    				<h3>BREAK: BỜ VỰC TỬ THẦN</h3>
    				<p><b>Đạo diễn: </b> Tigran Saakyan</p>
                    <p><b>Diễn viên: </b>  Irina Antonenko, Mikhail Filippov, Denis Kosyakov, Andrey Nazimov, Ingrid Olerinskaya</p>
    				<p><b>Thể loại: </b> Hồi hộp, Kinh Dị</p>
    				<p><b>Khởi chiếu: </b> 19/04/2019 </p>
    				<p><b>Thời lượng:</b>   85 Phút</p>
    				<p><b>Ngôn ngữ</b> Tiếng Nga phụ đề tiếng Việt</p>
                    <p><b>Rated:  C16 - PHIM CẤM KHÁN GIẢ DƯỚI 16 TUỔI</b></p>
    			</div>
    ...
    <footer class="py-5 bg-dark">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3">
            <p class="m-0 text-center text-white"><b>CÔNG TY TNHH MBC VIETNAM</b></p>
        ...
        <p class="m-0 text-center text-white">Copyright &copy; MinhBảo Cinema Website 2018</p>
      </div>
      <!-- /.container -->
    </footer>
    <!---------------------------------------------------------------------------->
