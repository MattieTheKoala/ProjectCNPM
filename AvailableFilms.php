    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      	<div class="container">
	        ...
	        <div class="collapse navbar-collapse" id="navbarResponsive">
                ...
                ?>
                <!-- hien dang nhap va dang ki khi chua co dang nhap -->
                <?php
	        ...
	        <div class="col-lg-3">
          	...
          	<h1 class="my-4" style="text-align: center;text-shadow:2px 2px 2px black"><b>MinhAn Motel</b></h1>
          		<div class="list-group">
            		<a href="BookTickets.php" class="list-group-item">Kiểm Tra Phí Tháng</a>
            		<a href="AvailableFilms.php" class="list-group-item">Thông Tin Các Phòng Thuê Chung</a>
            		<a href="UnAvailableFilms.php" class="list-group-item">Thông Tin Các Phòng Thuê Nguyên Căn</a>
